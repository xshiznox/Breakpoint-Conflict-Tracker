    ...
    public partial class MainForm : Form
    {
        ...
        private void LoadData()
        {
            categoryItems = new Dictionary<string, List<string>>
            {
                ...
                ["Headset"] = new List<string> { "Earpeice", "Ops-Core AMP Headset", "Peltor", "Revision ComCener2 Headset" }.OrderBy(x => x).ToList(),
                ["Gloves"] = new List<string> { "Paladin Nine Gloves", "Plastic Gloves", "Punk Gloves", "S&S WetWorX Cold Gloves", "S&S WetWorX Warm Gloves", "Scuba Gloves", "Sentinel Gloves", "Silencer Gloves", "Ski Gloves", "Soft Gloves", "Third Echelon Gloves", "VelSyst Trigger Gloves", "Wolf Extreme Cold Weather Mittens", "Wolf Gloves", "ONakley SI Assault Gloves" }.OrderBy(x => x).ToList(),
                ["Facemask"] = new List<string> { "3E Eclipse Balaclava Helmet", "AirSoft Skull Mask", "Architect Mask", "Architect Mask | Engineer", "Arcturus Ghost Hood", "Arcturus Warrior Hood", "Avon M50 Gas Mask", "Bodark Mask A", "Bodark Mask B", "Bodark Mask C", "Bodark Mask D", "Bodark Mask E", "Bulldog Gas Mask", "Claro Gentile Mask", "Sniper Balaclava", "Commissar Helm", "Crye Compact Assault Ghillie Hood", "Extreme Infiltrator Mask", "F-16 Fighter Helmet", "Flayed Skull | Panther", "Flir Nyx-7", "Cross-Nose Balaclava", "Flycatcher Mask", "Fourth Echelon Mask", "Future Soldier Headgear", "Future Soldier Mask", "Galvion Ballistic Helmet", "Golem Mask", "Golem Mask | Field Medic", "Half Mask", "Half Moon Balaclava", "Heavy Duty Gas Mask", "Heli Helmet", "Judge Mask", "Kevlar Ballistic Helmet", "MASKA-1SCh", "Mixed Material Ghillie Hood", "Ninja Half Mask", "Paladin Nine Mask", "Panoramic Gas Mask", "Pioneer Helmet | Sharpshooter", "Rebel Knight Helmet", "Rebel Plate Mask", "Revision SnowHawk Balaclava", "Rosebud Mask", "Scarf A", "Scarf B", "Shemagh", "Silencer Mask", "Silencer Mask | Echelon", "Silverback Mask", "Skull Balaclava", "Skull Ballistic Mask", "Sniper Balaclava", "Snow Woods Ghillie Hood", "Spetznas Balaclava", "Stealth Balaclava", "Steel Skull Ballistic Mask", "Syriyka Soviet Combat Hat", "Tree Leaves Ghillie Hood", "UA Heatgear Tactical Balaclava", "Wolf Enhanced Helmet A", "Wolf Enhanced Helmet B", "Wolf Mask", "Wolf Mask A", "Wolf Mask B", "Wolf Mask C", "Wrapped Shemagh", "Yellowleg Mask" }.OrderBy(x => x).ToList(),

                ["Pants"] = new List<string> { "5.11 Apex Pants", "5.11 Apex Pants - Kneepads", "5.11 Tactical Stryke Pants", "5.11 Tactical Stryke Pants - Kneepads", "Architect Pants", "Architect Pants | Engineer", "Arcturus Warrior Pants", "Armored Baggy Pants", "Armored Forest Tactical Pants", "Armored Heat Regulating Tactical Pants", "Armored Pants", "BLACKHAWK LW Pants", "BLACKHAWK Lightweight Pants", "BLACKHAWK Lightweight Pants - Kneepads", "BLACKHAWK Tactical Shorts", "Baggy Pants", "Bodark Pants", "Cargo Pants", "Cargo Pants A", "Cargo Pants - Kneepads", "Chinos", "Commissar Slacks", "Commissar Slacks | Sharpshooter", "Crye G3 Combat Pants", "Crye G3 Combat Pants - Kneepads", "Crye G3 Combatpants", "Crye G3 Kneepads", "Crye G4 Combat Pants", "First Spear Centurion Shorts", "Fixit Pants", "Flayed Legs | Panther", "Flayered Legs (Panther)", "Forest Tactical Pants", "Fourth Echelon Pants", "Fury Pants", "Ghost Ghili Pants", "Ghost Ghillie Pants", "Golem Pants", "Gorka Pants", "Heat Regulation Tac Pants", "Heat Regulating Tactical Pants", "Helikon-Tex CPU Pants", "Helikon-Text SP Kneepads", "Helikon-Tex CPU Pants - Kneepads", "High-tech Infiltraton Pants", "Hill's Pants", "Jeans", "Jeans A Kneepads", "Jeans - Kneepads", "Judge Pants", "Judge Pants | Assault", "Kilt", "Kyle Pants", "Long Shorts", "M88 'Afghanka Pants", "Mixed Material Ghillie Pants", "Nomad Pants", "Nomad", "Paladin Nine Pants", "Pioneer Pants | Pathfinder", "Punk Pants", "Reinforced Thigh Pads Pants", "Rosebud Pants", "Russian Summer Pants", "Scuba Pants", "Sentinal Combat Pants", "Sentinal Combat Pants - Kneepads", "Sentinal Mk. II Pants", "Sentinel MK2 Heavy Pants", "Silencer Pants", "Silencer Pants | Echelon", "Snow Woods Ghillie Pants", "Strap Shorts", "Survivor Pants", "TacStryke Kneepads", "Tactical Dry Pants", "Thigh Pad Shorts", "Thigh Pads Pants", "Third Echelon Pants", "Tree Leaves Ghillie Pants", "Tropical Combat Trousers", "Utility Work Pants", "Vasily Pants", "VelSyst Range Shorts", "Warrior Ghilli", "Wolf Enhanced Pants", "Wolf Tactical Pants", "Worn Out Punk Pants", "Yellowleg Pants" }.OrderBy(x => x).ToList(),
        ...
        private void SetupUI()
        {
            ...
            contextMenu.Items.Add("Remove").Click += RemoveMenuItem_Click;
