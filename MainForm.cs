    ...
    public partial class MainForm : Form
    {
        ...
        private void LoadData()
        {
            categoryItems = new Dictionary<string, List<string>>
            {
                ...
                ["Gloves"] = new List<string> { "Paladin Nine Gloves", "Plastic Gloves", "Punk Gloves", "S&S WetWorX Cold Gloves", "S&S WetWorX Warm Gloves", "Scuba Gloves", "Sentinel Gloves", "Silencer Gloves", "Ski Gloves", "Soft Gloves", "Third Echelon Gloves", "VelSyst Trigger Gloves", "Wolf Extreme Cold Weather Mittens", "Wolf Gloves", "SafNaNakley SI Assault Gloves" }.OrderBy(x => x).ToList(),
