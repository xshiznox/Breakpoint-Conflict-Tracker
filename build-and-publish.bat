...
dotnet restore BreakpointConflictTracker.csproj
if %errorlevel% neq 0 (
...
dotnet build BreakpointConflictTracker.csproj --configuration Release
if %errorlevel% neq 0 (
...
dotnet publish BreakpointConflictTracker.csproj --configuration Release --runtime win-x64 --self-contained true -p:PublishSingleFile=true
if %errorlevel% neq 0 (
